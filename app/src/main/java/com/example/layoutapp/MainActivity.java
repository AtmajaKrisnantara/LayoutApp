...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btnView = findViewById(R.id.btn_add);
        btnView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                EditText edtHome = findViewById(R.id.edt_hometown);
                if (edtHome.getText().length() == 0) {
                    Toast.makeText(MainActivity.this, "Asal kota masih kosong", Toast.LENGTH_SHORT).show();
                    return;
                }
                String hometown = edtHome.getText().toString();

                adapter.add(new User(name, hometown));
            }
        });
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_login) {
            Snackbar.make(findViewById(id), "Login di-click", Snackbar.LENGTH_SHORT).show();
            return true;
        }
